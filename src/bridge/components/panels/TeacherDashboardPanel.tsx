  ...
  return (
    ...
    >
      ...
      <div className="dashboard-grid" id="teacher-dashboard">
        ...
        <DashboardCard span={6} id="dash-todo-title" title="Today" titleColor="warm">
        ...
        <DashboardCard span={6} id="dash-publish-title" title="Recent posts" titleColor="lavender">
        ...
        <DashboardCard span={12} id="dash-stats-title" title="Class pulse" titleColor="sky">
        ...
        <DashboardCard span={12} id="dash-schedule-title" title="This week" titleColor="warm">
